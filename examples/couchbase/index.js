...
const CoucnbaseEventStore = cqrs.EventStore('couchbase');
const eventStore = new CoucnbaseEventStore(eventBus, { host: 'localhost', database: 'cqrs' });
...
eventBus.setHandler(Events.orderCreated, OrderReadModel);
